...
\begin{figure}
\centering{}\includegraphics[width=1\textwidth]{\string"../Python/plot-crop\string".pdf}\caption{ROC curves for problems 4 (b), 4 (c, i) and 4 (c, ii).\label{fig:roc-curves} }
\end{figure}
